...
需要 Node.js 22.19+，可使用交互命令向 `public/links.yml` 添加信息：
...
使用 [meodp](https://github.com/YunYouJun/meodp) 每周检查友链可访问性，结果见[交互状态报告](https://friends.yunyoujun.cn/status/)。检测结果供维护时参考，访问受限或单次失败不代表友链已失效。

维护说明：

- [检测与报告维护](https://github.com/YunYouJun/friends/blob/master/docs/link-checking.md)：本地检测、报告导出、每周自动检查与状态页部署。
- [飞书与邮件通知](https://github.com/YunYouJun/friends/blob/master/docs/notifications.md)：通知策略、机器人与 SMTP 配置、测试和故障处理。
